...
function set_dismiss_confetti_button(battery_data) {
  document.getElementById('canvas').insertAdjacentHTML('afterend', '<button id="dismiss-button" class="dismiss-button mdl-button mdl-js-button mdl-button--raised mdl-button--colored mdl-color--green mdl-js-ripple-effect">Doel bereikt</button>');
